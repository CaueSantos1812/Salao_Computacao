...
class Consultorio:
    ...
    def ver_cliente(self):
        nomes = [cliente.nome for cliente in self.clientes]
    ...
    def mostrar_agenda(self):
        if not self.agenda:
            ...
            return ## Ver se da pra tirar esse return sem perda de funcionalidade 
    ...
    def agendar(self):
        ...
        if not cliente_existente:
            ...
            self.cadastro()
            cliente_existente = self.clientes[-1] # Assume a ultima cadastrada, se a lista se reorganizar, pode dar pau
